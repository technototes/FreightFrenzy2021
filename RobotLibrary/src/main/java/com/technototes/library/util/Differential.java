...
public class Differential {
    ...
    private double average = 0, difference = 0;
    ...
    public enum DifferentialPriority {
        ...
        /**
         * Calculates the value for the differential output generated by adding
         * @param avg the average output for the diff
         * @param dif the difference output for the diff
    ...
    /**
     * Set the difference of the differential.
     * This corresponds to whatever setting the two nputs
     * to the opposite direction will do
     * @param value the value to set
     * @return this
     */
    public Differential setDifferenceOutput(double value){
        difference = value;
        return updateOutputs();
    }
     ...
     * @param dValue the difference output
     * @return this
     */
    ...
    private Differential updateOutputs(){
        input1.accept(priority.calculateA(average, difference, inputMin, inputMax));
        input2.accept(priority.calculateS(average, difference, inputMin, inputMax));
        return this;
    }
    ...
    /**
     * Gets the current difference between the two differential inputs and the average,
     * equating to one of the outputs
     * @return the current average
     */
