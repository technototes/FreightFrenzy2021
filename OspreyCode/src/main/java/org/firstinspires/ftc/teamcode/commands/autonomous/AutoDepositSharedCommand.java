...
public class AutoDepositSharedCommand extends SequentialCommandGroup {
    public AutoDepositSharedCommand(DrivebaseSubsystem drive, IntakeSubsystem intake, LiftSubsystem lift, DepositSubsystem deposit, ExtensionSubsystem extension){
        super(new DriveRelocalizeCycleCommand(drive),
                new RegenerativeTrajectorySequenceCommand(drive, RobotConstants.WAREHOUSE_TO_HUB, drive)
                        ...
                        new WaitCommand(0.5).andThen(
                                ...
                                new ArmRaiseCommand(deposit).andThen(new ExtensionOutCommand(extension))),
