...
import org.firstinspires.ftc.teamcode.PhoenixDriveBase;
...
public class DriveCommand implements Command {
    ...
    public PhoenixDriveBase subsystem;
    public DoubleSupplier x, y, r;
    public BooleanSupplier straight;
    public DriveCommand(PhoenixDriveBase sub, Stick stick1, Stick stick2) {
        addRequirements(sub);
        subsystem = sub;
    ...
    public DriveCommand(PhoenixDriveBase sub, Stick stick1, Stick stick2, CommandButton straighten) {
        addRequirements(sub);
        subsystem = sub;
        x = stick1.getXSupplier();
        y = stick1.getYSupplier();
