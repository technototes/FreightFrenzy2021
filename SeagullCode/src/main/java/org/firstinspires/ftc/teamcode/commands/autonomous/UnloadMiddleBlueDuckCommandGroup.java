...
public class UnloadMiddleBlueDuckCommandGroup extends SequentialCommandGroup {
    public UnloadMiddleBlueDuckCommandGroup(DrivebaseSubsystem drive, DumpSubsystem bucket, IntakeSubsystem intake, VisionSubsystem vision) {
        super(
                new TrajectorySequenceCommand(drive, AutonomousConstants.BLUE_DUCK_START_TO_ALLIANCE_HUB_LEVEL2), // Different duck constant
                ...
                new TrajectorySequenceCommand(drive, AutonomousConstants.BLUE_ALLIANCE_HUB_LEVEL2_TO_DUCK_COLLECT1), // Different park command
