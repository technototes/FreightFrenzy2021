...
public class RedDepotRemainderCommandGroup extends SequentialCommandGroup {
    public RedDepotRemainderCommandGroup(DrivebaseSubsystem drive, DumpSubsystem bucket, IntakeSubsystem intake, VisionSubsystem vision) {
        super(
/*
WRONG
                  new TrajectorySequenceCommand(drive, AutonomousConstants.RED_DEPOT_COLLECT1_TO_ALLIANCE_HUB_LEVEL_3).alongWith(new IntakeOutCommand(intake).sleep(0.5).andThen(new IntakeStopCommand(intake))),
