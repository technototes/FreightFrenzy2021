...
public class AutoRedMiddleLevelCommandGroup extends SequentialCommandGroup {
    public AutoRedMiddleLevelCommandGroup(DrivebaseSubsystem drive, DumpSubsystem bucket, IntakeSubsystem intake) {
        super(
                new TrajectorySequenceCommand(drive, AutonomousConstants.RED_DEPOT_START_TO_ALLIANCE_HUB_LEVEL2),
