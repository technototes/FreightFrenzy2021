...
public class UnloadTopBlueDuckCommandGroup extends SequentialCommandGroup {
    public UnloadTopBlueDuckCommandGroup(DrivebaseSubsystem drive, DumpSubsystem bucket, IntakeSubsystem intake, VisionSubsystem vision) {
        super(
                  new TrajectorySequenceCommand(drive, AutonomousConstants.BLUE_DUCK_START_TO_ALLIANCE_HUB_LEVEL3), // Different duck constant
                  ...
                  new TrajectorySequenceCommand(drive, AutonomousConstants.BLUE_ALLIANCE_HUB_LEVEL3_TO_DUCK_COLLECT1), // Different park command
