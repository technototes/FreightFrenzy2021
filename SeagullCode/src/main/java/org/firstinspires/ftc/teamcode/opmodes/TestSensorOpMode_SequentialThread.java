...
@TeleOp(name = "TestSensor_SequentialThread")
@SuppressWarnings("unused")
public class TestSensorOpMode_SequentialThread extends CommandOpMode implements Loggable {
    ...
    public void uponInit() {
        ...
        sensorSubsystem = new SensorSubsystem(hardware.frontRangeSensor,
                ...
                SensorSubsystem.ReadType.SEQUENTIAL_THREAD);
