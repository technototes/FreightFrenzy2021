...
public class AutoState {
    ...
    public static final double FIRST_WOBBLE_DROP_X_0 = 63;
    public static final double FIRST_WOBBLE_DROP_Y_0 = -5;
    public static final double FIRST_WOBBLE_DROP_ROTATION_0 = 0;
    public static final double FIRST_WOBBLE_DROP_X_1 = 87;
    public static final double FIRST_WOBBLE_DROP_Y_1 = 17;
    public static final double FIRST_WOBBLE_DROP_ROTATION_1 = 0;
    public static final double FIRST_WOBBLE_DROP_X_4 = 111;
    public static final double FIRST_WOBBLE_DROP_Y_4 = -5;
    public static final double FIRST_WOBBLE_DROP_ROTATION_4 = 0;

    public static final double SECOND_WOBBLE_DROP_OFFSET_X = 5;
    public static final double SECOND_WOBBLE_DROP_OFFSET_Y = 7;


    public static final double SECOND_WOBBLE_GRAB_X = 27;
